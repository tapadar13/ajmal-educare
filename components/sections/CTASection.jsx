...
const CTASection = () => {
  return (
    <section className="relative overflow-hidden bg-white">
      ...
      <div className="relative py-12 sm:py-20 lg:py-16">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center">
              <a 
                href="/contact"
                className="group relative isolate inline-flex items-center justify-center overflow-hidden text-left font-medium transition duration-300 ease-[cubic-bezier(0.4,0.36,0,1)] before:duration-300 before:ease-[cubic-bezier(0.4,0.36,0,1)] before:transtion-opacity rounded-md shadow-[0_1px_theme(colors.white/0.07)_inset,0_1px_3px_theme(colors.gray.900/0.2)] before:pointer-events-none before:absolute before:inset-0 before:-z-10 before:rounded-md before:bg-gradient-to-b before:from-white/20 before:opacity-50 hover:before:opacity-100 after:pointer-events-none after:absolute after:inset-0 after:-z-10 after:rounded-md after:bg-gradient-to-b after:from-white/10 after:from-[46%] after:to-[54%] after:mix-blend-overlay text-sm h-12 px-4 sm:px-6 ring-1 bg-gray-900 text-white ring-gray-900 w-full sm:w-auto"
              >
                <Phone className="w-5 h-5 mr-2 sm:mr-3" />
                <span className="text-xs sm:text-sm">TALK TO OUR COUNSELLING EXPERTS</span>
                <ArrowRight className="w-4 h-4 ml-2 sm:ml-3 group-hover:translate-x-1 transition-transform" />
              </a>
