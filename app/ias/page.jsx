        ...
        <section className="relative bg-gray-50">
          ...
          <div className="relative container mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-2xl font-bold sm:text-lg text-gray-700">Inspired By Excellence & Innovation</p>
              <p className="text-2xl font-bold sm:text-lg text-gray-700 mt-2">We offer a wide range of high quality of teaching and extra-curricular activities.</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
              <div className="relative rounded-2xl border-2 border-black overflow-hidden">
                <Card className="relative z-0 rounded-[inherit] h-full shadow-none border-0">
                  {/* Image Placeholder with Centered Title */}
                  <div className="relative h-48 bg-gradient-to-br from-gray-100 to-gray-200 flex items-center justify-center">
                    <CardTitle className="text-gray-900 text-xl font-bold text-center px-4">24×7 Library Access</CardTitle>
                  </div>
              ...
              <div className="relative rounded-2xl border-2 border-black overflow-hidden">
                <Card className="relative z-0 rounded-[inherit] h-full shadow-none border-0">
                  {/* Image Placeholder with Centered Title */}
                  <div className="relative h-48 bg-gradient-to-br from-gray-100 to-gray-200 flex items-center justify-center">
                    <CardTitle className="text-gray-900 text-xl font-bold text-center px-4">Digital Smart Classrooms</CardTitle>
                  </div>
                  <CardContent className="px-6 pb-6">
                    <CardDescription className="text-gray-600 text-lg">
              ...
              <div className="relative rounded-2xl border-2 border-black overflow-hidden">
                <Card className="relative z-0 rounded-[inherit] h-full shadow-none border-0">
                  {/* Image Placeholder with Centered Title */}
                  <div className="relative h-48 bg-gradient-to-br from-gray-100 to-gray-200 flex items-center justify-center">
                    <CardTitle className="text-gray-900 text-xl font-bold text-center px-4">Hostel Facility</CardTitle>
                  </div>
                  <CardContent className="px-6 pb-6">
                    <CardDescription className="text-gray-600 text-lg">
              ...
              <div className="relative rounded-2xl border-2 border-black overflow-hidden">
                <Card className="relative z-0 rounded-[inherit] h-full shadow-none border-0">
                  {/* Image Placeholder with Centered Title */}
                  <div className="relative h-48 bg-gradient-to-br from-gray-100 to-gray-200 flex items-center justify-center">
                    <CardTitle className="text-gray-900 text-xl font-bold text-center px-4">Online Courses</CardTitle>
                  </div>
                  <CardContent className="px-6 pb-6">
                    <CardDescription className="text-gray-600 text-lg">
            ...
            <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto">
                ...
                <Card className="relative z-0 rounded-none h-full shadow-none border-0">
                  <CardHeader className="flex flex-row items-center gap-3 pt-6 pb-6 bg-gradient-to-r from-blue-600 to-purple-600">
                    <div className="w-10 h-10 rounded-lg bg-white/20 flex items-center justify-center">
                      {GradientIcon({ Icon: CalendarCheck2, id: 'card-calendar' })}
                    </div>
                    <div>
              ...
              <div className="relative rounded-2xl border-2 border-black overflow-hidden">
                <Card className="relative z-0 rounded-none h-full shadow-none border-0">
                  <CardHeader className="flex flex-row items-center gap-3 pt-6 pb-6 bg-gradient-to-r from-blue-600 to-purple-600">
                    <div className="w-10 h-10 rounded-lg bg-white/20 flex items-center justify-center">
                      {GradientIcon({ Icon: GraduationCap, id: 'card-grad' })}
                    </div>
                    <div>
              ...
              <div className="relative rounded-2xl border-2 border-black overflow-hidden">
                <Card className="relative z-0 rounded-none h-full shadow-none border-0">
                  <CardHeader className="flex flex-row items-center gap-3 pt-6 pb-6 bg-gradient-to-r from-blue-600 to-purple-600">
                    <div className="w-10 h-10 rounded-lg bg-white/20 flex items-center justify-center">
                      {GradientIcon({ Icon: GraduationCap, id: 'card-foundation' })}
                    </div>
                    <div>
              ...
              <div className="relative rounded-2xl border-2 border-black overflow-hidden">
                <Card className="relative z-0 rounded-none h-full shadow-none border-0">
                  <CardHeader className="flex flex-row items-center gap-3 pt-6 pb-6 bg-gradient-to-r from-blue-600 to-purple-600">
                    <div className="w-10 h-10 rounded-lg bg-white/20 flex items-center justify-center">
                      {GradientIcon({ Icon: GraduationCap, id: 'card-mentorship' })}
                    </div>
                    <div>
